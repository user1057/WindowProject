...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //int mixvarLocation = glGetUniformLocation(ourShader.ID, "mixvar");
        //glUniform1f(mixvarLocation, mixamount);
        //OR
        ourShader.setFloat("mixvar", mixamount);
